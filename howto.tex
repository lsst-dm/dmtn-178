...
The documents continuous generation is implemented in the \texttt{docugen} worker, that deploy a \texttt{docsci/docugen-worker} docker image.
This docker image is defined in \url{https://github.com/docs-ci/docs-ci-workers-docker} repository, \texttt{docs} folder.
